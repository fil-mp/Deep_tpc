...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='TPC Preprocess')
    parser.add_argument('--gpu', type=int, default=0, help='gpu id')
    parser.add_argument('--llm_ckp_dir', type=str, default='./gpt2', help='llm checkpoints dir')
    parser.add_argument('--dataset', type=str, default='ETTh1', 
                        help='dataset to preprocess, options:[ETTh1, electricity, weather, traffic, ETTm1, ETTm2, ETTh2, Solar]')
    ...
    assert args.dataset in ['ETTh1', 'electricity', 'weather', 'traffic', 'ETTm1', 'ETTm2', 'ETTh2', 'Solar']
