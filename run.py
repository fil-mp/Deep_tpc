...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True, default='GPT2WithTPC',
                        help='model name, options: [GPT2WithTPC]')
    ...
    #GPT2TPC specific config
    parser.add_argument('--tpc_layers', type=int, nargs='+', default=[6,7,8,9,10,11,12], help='indices of GPT2 layers to replace with TPC blocks')
    parser.add_argument('--num_fusion_tokens', type=int, default=20, help='number of learnable fusion tokens for TPC attention')
